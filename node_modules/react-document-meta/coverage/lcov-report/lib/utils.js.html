...
export function clone ({ children, ...source }) {
  return source ? JSON.parse( JSON.stringify( source ) ) : <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
}
&nbsp;
...
export function forEach ( arr, fn ) {
  Array.prototype.slice.call( arr || <span class="branch-1 cbranch-no" title="branch not covered" >[] </span>).forEach( fn );
}
&nbsp;
/**
 * Validation
